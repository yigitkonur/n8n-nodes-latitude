...
### Changed
- Updated to ESLint 9.x with flat config (eslint.config.mjs)
- Added dark mode icon support for credentials
- Updated TypeScript ESLint to v8.x
- Improved gulpfile with JSON metadata copying
- Better icon handling with light/dark variants

### Fixed
- Credential icon path now properly references icons folder
- All n8n community node standard compliance issues resolved

### Removed
- Legacy .eslintrc.js configuration (replaced with flat config)
- Unnecessary root index.ts export file
